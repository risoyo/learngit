...
static void generateColumnTypes(
	Parse *pParse,      /* Parser context 定义语义分析器*/
	SrcList *pTabList,  /* List of tables 输出表的集合的语法树*/
	ExprList *pEList    /* Expressions defining the result set 定义表达式的结果集*/
	){
...
**生成代码会告诉VDBE结果集中的列名.这些信息用于提供回调中azCol[] 的值。
*/
